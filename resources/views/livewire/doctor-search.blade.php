<div class="card">
    <div class="card-header">
      <h3 class="card-title text-info d-block">doctors Table</h3>
            ...
            <tr>
              ...
              <td>
                ...
                <div class="dropdown-menu" role="menu" style="">
                  <a class="dropdown-item" href="{{route('admin.doctors.edit',['doctor'=>$doctor->id])}}">Edit</a>
                  <form action="{{route('admin.doctors.delete',['doctor'=>$doctor->id])}}" method="POST">
                    @csrf
                    @method('delete')
