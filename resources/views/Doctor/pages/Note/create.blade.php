  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="form-horizontal" method='POST' action="{{route('doctor.patient.notes.store',['patient'=>$patient->id])}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="form-group row">
                  ...
                  <textarea type="text" rows="5" class="form-control"  placeholder="Your Note" name="message" >{{old('message')}}</textarea>
                  @error('message')
