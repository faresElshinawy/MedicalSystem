  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="form-horizontal" method='POST' action="{{route('admin.doctors.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group" data-select2-id="40">
                            <select class="form-control select2 select2-hidden-accessible" name="specialty" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{old('specialty')}}">
                              ...
                              <option data-select2-id="{{$specialty->id}}" value="{{$specialty->id}}">{{$specialty->name}}</option>
                              @endforeach
                            </select>
                          </div>
                      @error('specialty')
