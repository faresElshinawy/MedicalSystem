  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="form-horizontal" method='POST' action="{{route('admin.specialties.update',['specialty'=>$specialty->id])}}" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control"  placeholder="Name" name="name" value='{{old('name')??$specialty->name}}'>
                  @error('name')
              ...
              @enderror
                ...
                <div class="container-fluid my-3 mx-auto d-flex justify-content-center">
                    @if ($specialty->image)
                    <img src="{{asset('uploads/Specialties/'.$specialty->image)}}" width="300" height="150" class="img-fluid" alt="">
                    @else
