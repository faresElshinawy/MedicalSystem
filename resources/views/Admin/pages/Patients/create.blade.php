  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="form-horizontal" method='POST' action="{{route('admin.patients.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control"  name="birthdate" value='{{old('date')}}'>
                        @error('date')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-sm-10">
                        <div class="form-group" data-select2-id="40">
                            <select class="form-control select2 select2-hidden-accessible" name="doctor" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" value="{{old('doctor')}}">
                              ...
                              <option data-select2-id="{{$doctor->id}}" value="{{$doctor->id}}">{{$doctor->name}}</option>
                              @endforeach
                            </select>
                          </div>
                        @error('doctor')
